...
//recibe indice de char, y lo devuelve como cuando se recorre un arreglo
...
//Devuelve POSICION INDICE del primer character de la palabra que deseamos buscar
console.log(str_5.indexOf("Pablo")) //9
//Devuelve el CHARACTER del indice que indicamos 
console.log(str_5.charAt(9)) // P
//Devuelve POSICION INDICE del primer character de LA ULTIMA INSTANCIA
